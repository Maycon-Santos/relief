				...
				<div className="header-content">
					<div>
						...
						<p className="app-subtitle">
							Hybrid local development orchestration
						</p>
					</div>
				...
				{status && (
					<div className="status-bar">
						...
						<div className="status-item">
							...
							<span className="status-value status-stopped">
								{status.stopped}
							</span>
						</div>
						{status.errors > 0 && (
							<div className="status-item">
								...
								<span className="status-value status-error">
									{status.errors}
								</span>
							</div>
						)}
						<div className="status-item">
							...
							<span
								className={`status-value ${status.traefik_running ? "status-running" : "status-stopped"}`}
							>
